...
}),obj},$.fn.serializeJSON=function(){return JSON.stringify($(this).serializeObject())},$.toHTML=function(str){return $("<div>").html(str).html()},$.fn.toHTML=function(){return $.toHTML(this.clone())},function(){var Bloop=function(items){this.items=items,this.start=0,this.end=items.length-1,this.node=null,this.stopped=!1};$.extend(Bloop.prototype,{isLooping:function(){return this.stopped?!1:Math.abs(this.start-this.end)>1?(this.node=Math.floor((this.start+this.end)/2),!0):!1},flip:function(flip){flip?this.end=this.node-1:this.start=this.node+1
