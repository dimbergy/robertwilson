...
<?php if( $target->isViewer() ){ ?>
	<?php echo JText::_( 'APP_SHARES_SHARED_YOUR_OWN' ); ?>
	<?php if ( isset( $sourcelink ) ) { ?>
		<a href="<?php echo $sourcelink; ?>"><?php echo JText::_( 'APP_SHARES_SHARED_OWN_POST' ); ?></a>.
	<?php } else { ?>
		<?php echo JText::_( 'APP_SHARES_SHARED_OWN_POST' ); ?>
	<?php } ?>
<?php } else { ?>
