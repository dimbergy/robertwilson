...
<li class="article-item" data-article-list-item>
	...
	<div class="article-item-meta row-fluid">
		<div class="pull-left">
			<span class="in">
		...
		<div class="pull-right">
			...
			<span class="small"><?php echo $this->html( 'string.date' , $article->created , 'd/m/Y'); ?></span>
		</div>
	...
	<div class="article-item-actions row-fluid mt-15">

		<div class="article-item-actions-readmore pull-right small">
