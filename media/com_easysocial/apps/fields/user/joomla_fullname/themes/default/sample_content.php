...
<div data-field-joomla_fullname>
	...
	<ul class="input-vertical unstyled" <?php if( $params->get( 'format' , 1 ) != 4 ) { ?>style="display: none;"<?php } ?> data-fullname-format>
		<li>
			<input type="text"
				size="30"
				class="input input-xlarge"
	...
	<ul class="input-vertical unstyled" <?php if( $params->get( 'format' , 1 ) != 5 ) { ?>style="display: none;"<?php } ?> data-fullname-format>
		<li>
			<input type="text"
				size="30"
				class="input input-xlarge"
