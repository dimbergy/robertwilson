...
class SocialFieldsUserAddress extends SocialFieldItem
{
	...
	public function onRegister( &$post, &$registration )
	{
		...
		{
			$value 	= $this->getAddressValue( $post[ $this->inputName ] );
		}
	...
	{
		$address 	= $this->getAddressValue( $post[ $this->inputName ] );
	...
	public function onEdit( &$post, &$user, $errors )
	{
		...
		// Get the value
		$value 	= $this->getAddressValue( $value );
	...
	{
		$data = $this->getAddressValue( $post[ $this->inputName ] );
	 ...
	 * @param	string
	 */
	public function getAddressValue( &$data = '', $init = true )
	{
		$value 	= '';
	...
	{
		$value 	= $this->getAddressValue( $this->value );
	...
	public function onIndexerSearch( $itemCreatorId, $keywords, $userFieldData )
	{
		...
		// $data 	= $this->getAddressValue( $this->value );
