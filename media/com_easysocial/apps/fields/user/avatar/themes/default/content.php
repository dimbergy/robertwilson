...
?>
<div data-field-avatar class="data-field-avatar" data-default="<?php echo $defaultAvatar; ?>" data-has-avatar="<?php echo $hasAvatar; ?>">
	<ul class="input-vertical unstyled">
		...
		<li data-field-avatar-remove <?php if( !$hasAvatar ) { ?>style="display: none;"<?php } ?>>
			<a href="javascript:void(0);" data-field-avatar-remove-button><?php echo JText::_( 'PLG_FIELDS_AVATAR_REMOVE_BUTTON' ); ?></a>
		</li>
