...
?>
<div id="fd_" class="ui">
<div data-with-calendar class="" <?php if( !$params->get( 'calendar' ) ) { ?>style="display: none;"<?php } ?>>
</div>
</div>
...
<div data-yearprivacy class="data-field-birthday-yearprivacy mt-10" <?php if( !$params->get( 'year_privacy' ) ) { ?>style="display: none;"<?php } ?>>
