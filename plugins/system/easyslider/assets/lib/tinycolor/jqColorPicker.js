;(function($, Colors, undefined){
	...
	var $document = $(document),
		...
		_css = '.cp-color-picker{overflow:hidden;' +
			'background-color:#23262F;color:#bbb;font-family:Arial,Helvetica,sans-serif;' +
			'font-size:12px;font-weight:400;cursor:default;}' +
			'.cp-color-picker>div{position:relative;overflow:' +
			...
			'p-alpha{clear:both;width:100%;height:16px;margin-top:6px;margin-bottom:3px;backgroun' +
	...
	function render(toggled) {
		$(_options.parentELEM).append(_colorPicker.$UI);
