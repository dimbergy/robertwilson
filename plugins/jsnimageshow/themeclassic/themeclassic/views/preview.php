 ...
 * @version $Id: preview.php 6411 2011-05-27 07:09:16Z trungnq $
 * @license GNU/GPL v2 http://www.gnu.org/licenses/gpl-2.0.html
 */
defined('_JEXEC') or die( 'Restricted access' );
$objJSNUtils 	= JSNISFactory::getObj('classes.jsn_is_utils');
$baseURL 		= $objJSNUtils->overrideURL();
$URLLocalFile	= dirname($baseURL).'/plugins/'.$this->_showcaseThemeType.'/'.$this->_showcaseThemeName.'/'.$this->_showcaseThemeName.'/assets/swf/';
$baseURL		= $baseURL;
