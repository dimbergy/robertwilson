...
//                                 <div class="jsn-column-content item-container '.$shortcode_data.' " data-column-class="' . $span . '" >
//                                     <div class="jsn-handle-drag jsn-horizontal jsn-iconbar-trigger" ><div class="jsn-iconbar layout" style="display:block;"><a class="item-delete column" onclick="return false;" title="'.JText::_('Delete column').'" href="#"><i class="icon-trash"></i></a></div></div>
