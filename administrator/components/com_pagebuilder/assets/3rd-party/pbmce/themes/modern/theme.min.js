pbmce.ThemeManager.add("modern", function(a) {
    function b() {
        function b(b) {
            var d, e = [];
        ...
        var c = [];
        if (pbmce.isArray(j.toolbar)) {
            if (0 === j.toolbar.length) return;
            pbmce.each(j.toolbar, function(a, b) {
                j["toolbar" + (b + 1)] = a
            }), delete j.toolbar
        }
    ...
    function c() {
        ...
        function c(c) {
            var d, e, f, g, h;
            if (h = pbmce.makeMap((j.removed_menuitems || "").split(/[ ,]/)), j.menu ? (e = j.menu[c], g = !0) : e = n[c], e) {
                d = {
                    text: e.title
    ...
    function g(e) {
        ...
        return j.fixed_toolbar_container && (o = m.select(j.fixed_toolbar_container)[0]), j.content_editable = !0, a.on("focus", function() {
            e.skinUiCss ? pbmce.DOM.styleSheetLoader.load(e.skinUiCss, l, l) : l()
        }), a.on("blur hide", h), a.on("remove", function() {
            n && (n.remove(), n = null)
        }), e.skinUiCss && pbmce.DOM.styleSheetLoader.load(e.skinUiCss), {}
    }

    function h(f) {
        var g, h, l;
        return f.skinUiCss && pbmce.DOM.loadCSS(f.skinUiCss), g = i.panel = k.create({
            type: "panel",
            role: "application",
            classes: "pbmce",
        ...
        }), j.readonly && g.find("*").disabled(!0), a.fire("BeforeRenderUI"), g.renderBefore(f.targetNode).reflow(), j.width && pbmce.DOM.setStyle(g.getEl(), "width", j.width), a.on("remove", function() {
            g.remove(), g = null
        }), d(g), {
    ...
    i.renderUI = function(b) {
        ...
        if (c) {
            var d = j.skin_url;
            d = d ? a.documentBaseURI.toAbsolute(d) : pbmce.baseURL + "/skins/" + c, b.skinUiCss = pbmce.Env.documentMode <= 7 ? d + "/skin.ie7.min.css" : d + "/skin.min.css", a.contentCSS.push(d + "/content" + (a.inline ? ".inline" : "") + ".min.css")
        }
        return a.on("ProgressState", function(a) {
            i.throbber = i.throbber || new pbmce.ui.Throbber(i.panel.getEl("body")), a.state ? i.throbber.show(a.time) : i.throbber.hide()
        }), j.inline ? g(b) : h(b)
