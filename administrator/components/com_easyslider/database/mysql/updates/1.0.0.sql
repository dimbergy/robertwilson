...
INSERT IGNORE INTO `#__jsn_easyslider_messages` (`msg_screen`, `published`, `ordering`) VALUES ('CONFIGURATION', 1, 1);
INSERT IGNORE INTO `#__jsn_easyslider_messages` (`msg_screen`, `published`, `ordering`) VALUES ('CONFIGURATION', 1, 2);
